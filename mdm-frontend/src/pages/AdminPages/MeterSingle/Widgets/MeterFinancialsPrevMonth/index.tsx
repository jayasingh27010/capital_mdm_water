...
import { viewMeterFinancialPrevMonth } from "src/api/Pages/Meters"


const MeterFinancialsPrevMonth: React.FC = () => {
    ...
    useEffect(() => {
        if (id) {
            setIsLoading(true)
            viewMeterFinancialPrevMonth(id)
                .then(({ data }: any) => {
                    setIsLoading(false)
...
export default MeterFinancialsPrevMonth