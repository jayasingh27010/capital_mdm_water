...
import { viewMeterFinancialThisMonth } from "src/api/Pages/Meters"


const MeterFinancialsThisMonth: React.FC = () => {
    ...
    useEffect(() => {
        if (id) {
            setIsLoading(true)
            viewMeterFinancialThisMonth(id)
                .then(({ data }: any) => {
                    setIsLoading(false)
...
export default MeterFinancialsThisMonth