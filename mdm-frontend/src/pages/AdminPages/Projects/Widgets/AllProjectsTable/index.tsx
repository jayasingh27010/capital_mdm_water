...
import { viewAllProjectsTable } from "src/api/Pages/Projects"
...
const tableId = "allProjectsTable"

const AllProjectsTable: React.FC = () => {
    const { data, isLoading } = useApi(viewAllProjectsTable)
