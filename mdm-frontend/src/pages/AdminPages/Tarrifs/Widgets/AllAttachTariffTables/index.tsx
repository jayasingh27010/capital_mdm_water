...
import { viewAllAttachTableTable } from "src/api/Pages/Tarrifs"

const tableId = "allAttachTable"

const AllAttachTariffTable: React.FC = () => {
    const { data, isLoading } = useApi(viewAllAttachTableTable)
    ...
    const apiReference = (filters: any): Promise<any> => {
        return new Promise((resolve) => {
            viewAllAttachTableTable(filters)
            .then(({ data }: any) => {
                resolve({
...
export default AllAttachTariffTable;