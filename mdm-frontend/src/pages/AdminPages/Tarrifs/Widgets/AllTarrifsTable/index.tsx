...
import { viewAllTarrifsTable } from "src/api/Pages/Tarrifs"

const tableId = "allTarrifsTable"

const AllTarrifsTable: React.FC = () => {
    const { data, isLoading } = useApi(viewAllTarrifsTable)
...
export default AllTarrifsTable