...
import { viewProjectGateways } from "src/api/Project"


const ProjectGateways: React.FC = () => {
        ...
        <Card>
            <div className="widget details-widget widget-user-actions">
                ...
                <div className="d-flex flex-row justify-content-center">
                    <span className="p-1 pe-2" style={{height: "30px", width: "35px"}}>
...
export default ProjectGateways