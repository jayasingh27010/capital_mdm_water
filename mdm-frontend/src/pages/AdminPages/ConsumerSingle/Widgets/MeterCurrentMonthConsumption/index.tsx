...
import { viewMeterCurrentMonthConsumption } from "src/api/Pages/Consumers"

const MeterCurrentMonthConsumption: React.FC = () =>{
    ...
    useEffect(() => {
        if (id) {
            setIsLoading(true)
            viewMeterCurrentMonthConsumption(id)
                .then(({ data }: any) => {
                    setIsLoading(false)
...
export default MeterCurrentMonthConsumption