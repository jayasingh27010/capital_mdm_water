...
import { viewDashboardGatewayDetails } from "src/api/Pages/Dashboard"


const DashboardGateways: React.FC = () => {
        ...
        <Card>
            <div className="widget details-widget widget-user-actions">
                ...
                <div className="d-flex flex-row justify-content-center">
                    <span className="p-1 pe-2 pb-1" style={{height: '35px', width: '35px'}}>
                        <SVGIcon iconName="Link" fill="#000" stroke="#000"/>
                    </span>
...
export default DashboardGateways