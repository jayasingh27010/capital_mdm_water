...
forgetPasswordRouter.post("/user/forget_password", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield sendOtpSchema.validateAsync(req.body);
        const { username } = req.body;
        const data = yield DBservice_1.default.User.verifyUserForgotPassword(username);
